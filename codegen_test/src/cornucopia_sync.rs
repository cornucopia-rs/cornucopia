            ...
            fn accepts(ty: &postgres_types::Type) -> bool {
                ...
                match *ty.kind() {
                    postgres_types::Kind::Composite(ref fields) => {
                        ...
                        fields . iter ( ) . all ( | f | match f . name ( ) { "txt" => < cornucopia_sync::private::Domain::<&'a str> as postgres_types :: ToSql > :: accepts ( f . type_ ( ) ) , "json" => < cornucopia_sync::private::Domain::<&'a serde_json::value::Value> as postgres_types :: ToSql > :: accepts ( f . type_ ( ) ) , "nb" => < cornucopia_sync::private::Domain::<i32> as postgres_types :: ToSql > :: accepts ( f . type_ ( ) ) , "arr" => < cornucopia_sync::private::Domain::<cornucopia_sync::private::DomainArray::<&'a serde_json::value::Value, &[&'a serde_json::value::Value]>> as postgres_types :: ToSql > :: accepts ( f . type_ ( ) ) , _ => false , } )
                    }
                    _ => false,
                }
            }
            ...
            fn accepts(ty: &postgres_types::Type) -> bool {
                ...
                match *ty.kind() {
                    postgres_types::Kind::Composite(ref fields) => {
                        ...
                        fields . iter ( ) . all ( | f | match f . name ( ) { "custom" => < &'a [super::super::types::public::CustomCompositeBorrowed<'a>] as postgres_types :: ToSql > :: accepts ( f . type_ ( ) ) , "spongebob" => < &'a [super::super::types::public::SpongebobCharacter] as postgres_types :: ToSql > :: accepts ( f . type_ ( ) ) , "domain" => < cornucopia_sync::private::Domain::<&'a str> as postgres_types :: ToSql > :: accepts ( f . type_ ( ) ) , _ => false , } )
                    }
                    _ => false,
                }
            }
