    ...
    pub mod bench {
        ...
        impl UsersStmt {
            pub fn bind<'a, C: GenericClient>(
                &'a mut self,
                client: &'a C,
            ) -> cornucopia_client::async_::Query<'a, C, User, User, 0> {
        ...
        impl PostsStmt {
            pub fn bind<'a, C: GenericClient>(
                &'a mut self,
                client: &'a C,
            ) -> cornucopia_client::async_::Query<'a, C, Post, Post, 0> {
                cornucopia_client::async_::Query {
                    client,
                    params: [],
                    stmt: &mut self.0,
        ...
        impl PostByUserIdsStmt {
            pub fn bind<'a, C: GenericClient>(
                ...
                client: &'a C,
                ids: &'a &'a [i32],
            ) -> cornucopia_client::async_::Query<'a, C, Post, Post, 1> {
                cornucopia_client::async_::Query {
                    client,
                    params: [ids],
                    stmt: &mut self.0,
        ...
        impl CommentsStmt {
            pub fn bind<'a, C: GenericClient>(
                &'a mut self,
                client: &'a C,
            ) -> cornucopia_client::async_::Query<'a, C, Comment, Comment, 0> {
                cornucopia_client::async_::Query {
                    client,
                    params: [],
                    stmt: &mut self.0,
        ...
        impl CommentsByPostIdStmt {
            pub fn bind<'a, C: GenericClient>(
                ...
                client: &'a C,
                ids: &'a &'a [i32],
            ) -> cornucopia_client::async_::Query<'a, C, Comment, Comment, 1> {
                cornucopia_client::async_::Query {
                    client,
                    params: [ids],
                    stmt: &mut self.0,
        ...
        impl SelectComplexStmt {
            pub fn bind<'a, C: GenericClient>(
                &'a mut self,
                client: &'a C,
            ) -> cornucopia_client::async_::Query<'a, C, SelectComplex, SelectComplex, 0>
            {
                cornucopia_client::async_::Query {
                    client,
                    params: [],
