...
pub mod queries {
    pub mod bench {
        ...
        #[derive(Debug)]
        pub struct InsertPostParams<'a> {
            pub body: Option<&'a str>,
            pub title: &'a str,
            pub user_id: i32,
        }
        impl<'a, C: GenericClient>
            cornucopia_client::sync::Params<'a, InsertPostStmt, Result<u64, postgres::Error>, C>
            for InsertPostParams<'a>
        {
            fn bind(
                &'a self,
                client: &'a mut C,
                stmt: &'a mut InsertPostStmt,
            ) -> Result<u64, postgres::Error> {
        ...
        impl<'a, C: GenericClient>
            cornucopia_client::sync::Params<'a, PostByUserIdsStmt, PostQuery<'a, C, Post, 1>, C>
        ...
        #[derive(Debug)]
        pub struct InsertCommentsParams<'a> {
            pub post_id: i32,
            pub text: &'a str,
        }
        impl<'a, C: GenericClient>
            cornucopia_client::sync::Params<'a, InsertCommentsStmt, Result<u64, postgres::Error>, C>
            for InsertCommentsParams<'a>
        {
            fn bind(
                &'a self,
                client: &'a mut C,
                stmt: &'a mut InsertCommentsStmt,
            ) -> Result<u64, postgres::Error> {
        ...
        impl<'a, C, T: 'a, const N: usize> UsersIdsQuery<'a, C, T, N>
        where
            C: GenericClient,
        {
        ...
        impl<'a, C, T: 'a, const N: usize> PostIdsQuery<'a, C, T, N>
        where
            C: GenericClient,
        {
        ...
        pub fn insert_user() -> InsertUserStmt {
            InsertUserStmt(cornucopia_client::sync::Stmt::new(
                "INSERT INTO users (name, hair_color) VALUES ($2, $1)",
            ))
        }
        ...
        pub fn insert_post() -> InsertPostStmt {
            InsertPostStmt(cornucopia_client::sync::Stmt::new(
                "INSERT INTO posts(title, user_id, body) VALUES ($2, $3, $1)",
            ))
        }
        ...
        impl PostByUserIdsStmt {
            ...
            pub fn params<'a, C: GenericClient>(
                &'a mut self,
                client: &'a mut C,
                params: &'a impl cornucopia_client::sync::Params<'a, Self, PostQuery<'a, C, Post, 1>, C>,
            ) -> PostQuery<'a, C, Post, 1> {
                params.bind(client, self)
            }
        }
        pub fn insert_comments() -> InsertCommentsStmt {
            InsertCommentsStmt(cornucopia_client::sync::Stmt::new(
                "INSERT INTO comments(text, post_id) VALUES ($2, $1)",
            ))
        }
        pub struct InsertCommentsStmt(cornucopia_client::sync::Stmt);
        impl InsertCommentsStmt {
            pub fn bind<'a, C: GenericClient>(
                &'a mut self,
                client: &'a mut C,
                post_id: &'a i32,
