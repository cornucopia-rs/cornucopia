    ...
    pub mod bench {
        ...
        pub mod sync {
            ...
            pub fn users() -> UsersStmt {
                UsersStmt(crate::client::sync::private::Stmt::new(
                    "SELECT * FROM users",
                ))
            }
            pub struct UsersStmt(crate::client::sync::private::Stmt);
            impl UsersStmt {
            ...
            pub fn insert_user() -> InsertUserStmt {
                InsertUserStmt(crate::client::sync::private::Stmt::new(
                    "INSERT INTO users (name, hair_color) VALUES ($1, $2)",
                ))
            }
            pub struct InsertUserStmt(crate::client::sync::private::Stmt);
            impl InsertUserStmt {
                pub fn bind<
                    'a,
                    C: GenericClient,
            ...
            pub fn posts() -> PostsStmt {
                PostsStmt(crate::client::sync::private::Stmt::new(
                    "SELECT * FROM posts",
                ))
            }
            pub struct PostsStmt(crate::client::sync::private::Stmt);
            impl PostsStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a mut C,
            ...
            pub fn post_by_user_ids() -> PostByUserIdsStmt {
                PostByUserIdsStmt(crate::client::sync::private::Stmt::new(
                    "SELECT * FROM posts WHERE user_id = ANY($1)",
                ))
            }
            pub struct PostByUserIdsStmt(crate::client::sync::private::Stmt);
            ...
            pub fn comments() -> CommentsStmt {
                CommentsStmt(crate::client::sync::private::Stmt::new(
                    "SELECT * FROM comments",
                ))
            }
            pub struct CommentsStmt(crate::client::sync::private::Stmt);
            impl CommentsStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a mut C,
            ...
            pub fn comments_by_post_id() -> CommentsByPostIdStmt {
                CommentsByPostIdStmt(crate::client::sync::private::Stmt::new(
                    "SELECT * FROM comments WHERE post_id = ANY($1)",
                ))
            }
            pub struct CommentsByPostIdStmt(crate::client::sync::private::Stmt);
            ...
            pub fn select_complex() -> SelectComplexStmt {
                SelectComplexStmt(crate::client::sync :: private :: Stmt :: new("SELECT u.id as myuser_id, u.name, u.hair_color, p.id as post_id, p.user_id, p.title, p.body FROM users as u LEFT JOIN posts as p on u.id = p.user_id"))
            }
            pub struct SelectComplexStmt(crate::client::sync::private::Stmt);
        ...
        pub mod async_ {
            ...
            pub fn users() -> UsersStmt {
                UsersStmt(crate::client::async_::private::Stmt::new(
                    "SELECT * FROM users",
                ))
            }
            pub struct UsersStmt(crate::client::async_::private::Stmt);
            impl UsersStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a C,
            ...
            pub fn insert_user() -> InsertUserStmt {
                InsertUserStmt(crate::client::async_::private::Stmt::new(
                    "INSERT INTO users (name, hair_color) VALUES ($1, $2)",
                ))
            }
            pub struct InsertUserStmt(crate::client::async_::private::Stmt);
            impl InsertUserStmt {
                pub async fn bind<
                    'a,
                    C: GenericClient,
            ...
            pub fn posts() -> PostsStmt {
                PostsStmt(crate::client::async_::private::Stmt::new(
                    "SELECT * FROM posts",
                ))
            }
            pub struct PostsStmt(crate::client::async_::private::Stmt);
            impl PostsStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a C,
            ...
            pub fn post_by_user_ids() -> PostByUserIdsStmt {
                PostByUserIdsStmt(crate::client::async_::private::Stmt::new(
                    "SELECT * FROM posts WHERE user_id = ANY($1)",
                ))
            }
            pub struct PostByUserIdsStmt(crate::client::async_::private::Stmt);
            impl PostByUserIdsStmt {
                pub fn bind<'a, C: GenericClient, T1: crate::client::ArraySql<Item = i32>>(
                    &'a mut self,
                    client: &'a C,
            ...
            pub fn comments() -> CommentsStmt {
                CommentsStmt(crate::client::async_::private::Stmt::new(
                    "SELECT * FROM comments",
                ))
            }
            pub struct CommentsStmt(crate::client::async_::private::Stmt);
            impl CommentsStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a C,
            ...
            pub fn comments_by_post_id() -> CommentsByPostIdStmt {
                CommentsByPostIdStmt(crate::client::async_::private::Stmt::new(
                    "SELECT * FROM comments WHERE post_id = ANY($1)",
                ))
            }
            pub struct CommentsByPostIdStmt(crate::client::async_::private::Stmt);
            impl CommentsByPostIdStmt {
                pub fn bind<'a, C: GenericClient, T1: crate::client::ArraySql<Item = i32>>(
                    &'a mut self,
                    client: &'a C,
            ...
            pub fn select_complex() -> SelectComplexStmt {
                SelectComplexStmt(crate::client::async_ :: private :: Stmt :: new("SELECT u.id as myuser_id, u.name, u.hair_color, p.id as post_id, p.user_id, p.title, p.body FROM users as u LEFT JOIN posts as p on u.id = p.user_id"))
            }
            pub struct SelectComplexStmt(crate::client::async_::private::Stmt);
            impl SelectComplexStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a C,
