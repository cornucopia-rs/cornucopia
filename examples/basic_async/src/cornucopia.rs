    ...
    Author",
        ...
        impl AuthorsStmt {
            pub fn bind<'a, C: GenericClient>(
                &'a mut self,
                client: &'a C,
            ) -> cornucopia_client::async_::Query<'a, C, Authors, Authors, 0> {
    ...
    Book",
        ...
        impl BooksOptRetParamStmt {
            pub fn bind<'a, C: GenericClient>(
                &'a mut self,
                client: &'a C,
            ) -> cornucopia_client::async_::Query<'a, C, Option<String>, Option<String>, 0>
            {
                cornucopia_client::async_::Query {
                    client,
                    params: [],
    ...
    Author.Id = $1",
        ...
        impl AuthorNameByIdStmt {
            pub fn bind<'a, C: GenericClient>(
                ...
                client: &'a C,
                id: &'a i32,
            ) -> cornucopia_client::async_::Query<'a, C, String, String, 1> {
                cornucopia_client::async_::Query {
                    client,
                    params: [id],
                    stmt: &mut self.0,
    ...
    Book",
        ...
        impl SelectTranslationsStmt {
            pub fn bind<'a, C: GenericClient>(
                &'a mut self,
                client: &'a C,
            ) -> cornucopia_client::async_::Query<'a, C, Vec<String>, Vec<String>, 0> {
                cornucopia_client::async_::Query {
                    client,
                    params: [],
                    stmt: &mut self.0,
