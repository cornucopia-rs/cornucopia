...
pub mod types {  }pub mod queries { pub mod module_1 { use futures::{{StreamExt, TryStreamExt}};use cornucopia_client::GenericClient; #[derive(Debug, Clone, PartialEq)] pub struct ExampleQuery { pub col1 : String }pub struct ExampleQueryBorrowed<'a> { pub col1 : &'a str }
            ...
            {
                pub fn map<R>(self, mapper: fn(ExampleQueryBorrowed) -> R) -> ExampleQueryQuery<'a,C,R> {
                    ExampleQueryQuery {
                        client: self.client,
                        params: self.params,
                        mapper,
...
=======
            ...
            }pub fn example_query<'a, C: GenericClient>(client: &'a  C, ) -> ExampleQueryQuery<'a,C, ExampleQuery> {
        ExampleQueryQuery {
            client,
            params: [],
            mapper: |it| ExampleQuery::from(it),
>>>>>>> 47033a9 (Less allocation and less branch)
        }
    } } }