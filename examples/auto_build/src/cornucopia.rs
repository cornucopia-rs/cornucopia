// This file was generated with `cornucopia`. Do not modify.
    ...
    #![allow(dead_code)]
    pub mod types {  }pub mod queries { pub mod module_1 { use futures::{{StreamExt, TryStreamExt}};use cornucopia_client::GenericClient;  #[derive( Debug, Clone, PartialEq,)] pub struct ExampleQuery { pub col1 : String }pub struct ExampleQueryBorrowed<'a> { pub col1 : &'a str }
            ...
            impl<'a, C, T:'a, const N: usize> ExampleQueryQuery<'a, C, T, N> where C: GenericClient {
                pub fn map<R>(self, mapper: fn(ExampleQueryBorrowed) -> R) -> ExampleQueryQuery<'a,C,R,N> {
                    ExampleQueryQuery {
                        client: self.client,
                        params: self.params,
                        query: self.query,
            ...
            } pub fn example_query<'a, C: GenericClient>(client: &'a  C, ) -> ExampleQueryQuery<'a,C, ExampleQuery, 0> {
                ExampleQueryQuery {
                    client,
                    params: [],
                    query: "SELECT
