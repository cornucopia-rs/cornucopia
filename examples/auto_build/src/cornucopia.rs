// This file was generated with `cornucopia`. Do not modify.
    ...
    #![allow(dead_code)]
    pub mod types {  }pub mod queries { pub mod module_1 { use futures::{{StreamExt, TryStreamExt}};use futures; use cornucopia_client::async_::GenericClient;  #[derive( Debug, Clone, PartialEq,)] pub struct ExampleQuery { pub col1 : String }pub struct ExampleQueryBorrowed<'a> { pub col1 : &'a str }
            ...
            impl<'a, C, T:'a, const N: usize> ExampleQueryQuery<'a, C, T, N> where C: GenericClient {
                ...
                ExampleQueryStmt(cornucopia_client::async_::Stmt::new("SELECT
    *
FROM
    example_table"))
            }
