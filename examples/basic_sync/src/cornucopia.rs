...
pub mod queries {
  ...
  VALUES ($1)",
    ...
    pub mod module_2 {
        ...
        cornucopia_sync::query! {AuthorsQuery, AuthorsBorrowed}
        cornucopia_sync::query! {StringQuery, & str}
        #[derive(Debug, Clone, PartialEq)]
        ...
        cornucopia_sync::query! {AuthorNameStartingWithQuery, AuthorNameStartingWithBorrowed}
        cornucopia_sync::query! {SuperSuperTypesPublicSpongebobCharacterQuery, super::super::types::public::SpongebobCharacter}
        #[derive(Debug, Clone, PartialEq)]
        ...
        cornucopia_sync::query! {SelectTranslationsQuery, SelectTranslationsBorrowed}
