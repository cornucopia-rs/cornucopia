...
",
    ...
    pub async fn books_from_author_id_tx<'a>(
        client: &Transaction<'a>,
        id: i32,
...
",
    ...
    pub async fn author_name_by_id_opt_tx<'a>(
        client: &Transaction<'a>,
        id: i32,
...
",
    ...
    pub async fn author_name_by_id_tx<'a>(
        client: &Transaction<'a>,
        id: i32,
    ) -> Result<String, Error> {
        let stmt = client
...
",
    ...
    pub async fn author_name_starting_with_tx<'a>(
        client: &Transaction<'a>,
        s: String,
    ) -> Result<Vec<(i32, String, i32, String)>, Error> {
        let stmt = client
